 ...
 *
 */
public class VTTSMarginalSumScoringFunction {
	
	CharyparNagelActivityScoring activityScoringA;
	CharyparNagelActivityScoring activityScoringB;
	
	public VTTSMarginalSumScoringFunction(ScoringParameters params) {
	...
	public final double getNormalActivityDelayDisutility(Activity activity, double delay) {
		...
		if (activity.getStartTime() != Time.getUndefinedTime() && activity.getEndTime() != Time.getUndefinedTime()) {
	...
	public final double getOvernightActivityDelayDisutility(Activity activityMorning, Activity activityEvening, double delay) {
        ...
        if (activityMorning.getStartTime() == Time.getUndefinedTime() && activityMorning.getEndTime() != Time.getUndefinedTime()) {
        ...
        if (activityEvening.getStartTime() != Time.getUndefinedTime() && activityEvening.getEndTime() == Time.getUndefinedTime()) {

 ...
 * @author balmermi
 */
/* deliberately package */ class PopulationReaderMatsimV7 extends MatsimXmlParser implements MatsimReader {
    private static final Logger log = Logger.getLogger(PopulationReaderMatsimV7.class);

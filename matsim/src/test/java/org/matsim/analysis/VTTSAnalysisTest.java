...
public class VTTSAnalysisTest {
	...
	public final void test1() {
		...
		String eventsFile = testUtils.getClassInputDirectory() + "test-events-1.xml";
	...
	public final void test2() {
		...
		String eventsFile = testUtils.getClassInputDirectory() + "test-events-2.xml";
	...
	// with 'help' activities, e.g. 'pt interaction'
	@Test
	public final void test3() {
		...
		ModeParams modeParams = new ModeParams(TransportMode.transit_walk);
		...
		String eventsFile = testUtils.getClassInputDirectory() + "test-events-3.xml";
